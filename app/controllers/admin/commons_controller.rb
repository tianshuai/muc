# encoding: utf-8
class Admin::CommonsController < Admin::Common

  #左侧导航样式
  before_filter do
    @css_admin_common = true
  end

  #分类列表
  def index
    @css_list_all = true
    @posts = Post.commons.order_b.paginate(:page => params[:page], :per_page => 10)
    render 'list'
  end
  ...
  def create
    ...
    respond_to do |f|
      if @post.save
        ...
        f.html { redirect_to admin_commons_path, notice: '创建成功!' }
  ...
  def update
    ...
    respond_to do |format|
      if @post.update_attributes(params[:post])
        ...
        format.html { redirect_to admin_commons_path, notice: '更新成功!' }
